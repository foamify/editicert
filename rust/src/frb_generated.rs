...
fn wire_MarqueeRect_contains_point_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            let api_that = <crate::api::canvas::MarqueeRect>::sse_decode(&mut deserializer);
            let api_point = <crate::api::canvas::CanvasPoint>::sse_decode(&mut deserializer);
            deserializer.end();
            move |context| {
...
fn wire_get_intersecting_ids_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            let mut deserializer =
                flutter_rust_bridge::for_generated::SseDeserializer::new(message);
            let api_rect = <crate::api::canvas::MarqueeRect>::sse_decode(&mut deserializer);
            let api_polygons = <Vec<crate::api::canvas::Polygon>>::sse_decode(&mut deserializer);
            let api_matrix_storage = <Vec<f64>>::sse_decode(&mut deserializer);
            deserializer.end();
            move |context| {
                transform_result_sse((move || {
...
fn wire_is_two_lines_intersecting_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            let mut deserializer =
                flutter_rust_bridge::for_generated::SseDeserializer::new(message);
            let api_line1 = <crate::api::canvas::Line>::sse_decode(&mut deserializer);
            let api_line2 = <crate::api::canvas::Line>::sse_decode(&mut deserializer);
            deserializer.end();
            move |context| {
                transform_result_sse((move || {
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        3 => wire_MarqueeRect_contains_point_impl(port, ptr, rust_vec_len, data_len),
        4 => wire_MarqueeRect_lines_impl(port, ptr, rust_vec_len, data_len),
        2 => wire_get_intersecting_ids_impl(port, ptr, rust_vec_len, data_len),
        1 => wire_is_two_lines_intersecting_impl(port, ptr, rust_vec_len, data_len),
