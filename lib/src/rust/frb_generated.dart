...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<bool> marqueeRectContainsPoint(
    ...
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        var arg0 = cst_encode_box_autoadd_marquee_rect(that);
        var arg1 = cst_encode_box_autoadd_canvas_point(point);
        return wire.wire_MarqueeRect_contains_point(port_, arg0, arg1);
      },
      codec: DcoCodec(
  ...
  Future<List<Line>> marqueeRectLines(
    ...
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        var arg0 = cst_encode_box_autoadd_marquee_rect(that);
        return wire.wire_MarqueeRect_lines(port_, arg0);
      },
      codec: DcoCodec(
        decodeSuccessData: dco_decode_list_line,
        decodeErrorData: null,
      ),
  ...
  Future<List<String>> getIntersectingIds(
    ...
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        var arg0 = cst_encode_box_autoadd_marquee_rect(rect);
        var arg1 = cst_encode_list_polygon(polygons);
        var arg2 = cst_encode_list_prim_f_64_loose(matrixStorage);
        return wire.wire_get_intersecting_ids(port_, arg0, arg1, arg2);
      },
      codec: DcoCodec(
  ...
  Future<bool> isTwoLinesIntersecting(
    ...
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        var arg0 = cst_encode_box_autoadd_line(line1);
        var arg1 = cst_encode_box_autoadd_line(line2);
        return wire.wire_is_two_lines_intersecting(port_, arg0, arg1);
      },
      codec: DcoCodec(
        decodeSuccessData: dco_decode_bool,
        decodeErrorData: null,
